...
exports.discreteFrechetDistance = discreteFrechetDistance;
exports.decode = decode;
exports.encode = encode;
exports.routeDistance = routeDistance;
exports.resampleRoute = resampleRoute;
exports.calculateSimilarity = calculateSimilarity;
exports.routeOverlap = routeOverlap;
exports.calculateEndpointSimilarity = calculateEndpointSimilarity;
...
function decode(encoded) {
    return polyline_1.default.decode(encoded);
}
...
function resampleRoute(route, interval = 100) {
    if (route.length < 2)
        return route;
    const resampled = [route[0]];
    let currentDist = 0;
...
function calculateSimilarity(routeA, routeB) {
...
function routeOverlap(routeA, routeB) {
    if (routeA.length < 2 || routeB.length < 2)
        return 0;
...
function calculateEndpointSimilarity(routeA, routeB) {
...
function overlapScore(routeA, routeB) {
